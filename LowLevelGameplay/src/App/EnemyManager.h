...
namespace LLGP 
{
	...
	public:
		...
		static void SetupEnemies(int enemyAmount, int citizenAmount, int trapAmount);
	...
	private:
		...
		static int _EnemiesRemaining;
		static int _CitizensRemaining;
	};
}
